...
COMMENT ON COLUMN billing_attempts.billing_period IS 'Оплачиваемый период: next_billing_date подписки на момент запуска. Уникален в паре с subscription_id';
